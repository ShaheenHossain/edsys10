...
from eagle.addons.edsys_edu.controllers.main import payfort_payment_status as edsys_edu_show_acd_payment
...
#                 bank_service_charge = 0.0 
    ...
    def create_attachment_re_reg_payment_receipt(self, voucher, re_regi):
        ...
        for record in voucher:
            ...
            if matching_report:
                result, format = eagle.report.render_report(request.cr, env.uid, [record.id],
