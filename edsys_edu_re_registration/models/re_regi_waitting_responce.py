...
from eagle.exceptions import except_orm, Warning, RedirectWarning
from eagle import netsvc
import eagle
import base64, re
import hashlib
import time
...
#         dyanamic_order_number = random.randrange(1000, 1000000, 1)
    ...
    def create_attachment_payment_receipt(self, voucher, re_regi):
        ...
        for record in voucher:
            ...
            if matching_report:
                result, format = eagle.report.render_report(self._cr, self._uid, [record.id],
